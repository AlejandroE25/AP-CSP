...
class MultiFactorAuth(tk.Tk):
    ...
    def authorize(self):
        ...
        if student_username == self.username and student_password == self.password:
            ...
            self.btn_auth = tk.Button(self.frame_auth, text="AUTHENTICATE",
    ...
    def authenticate(self):
        ...
        if (factor_info == self.answer):
            ...
            lbl_msg = tk.Label(self.frame_restrict, text="This is a restricted application.",
                               bg="sienna2")
            lbl_msg.config(font=("Arial", 18))
            lbl_msg.pack(pady=15)

            lbl_auth = tk.Label(self.frame_restrict,
